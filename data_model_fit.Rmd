...
model_glm_restr_D1 <- glm(anxious ~ bl_mn_idx_t + bl_mn_idx_t_m02a + bl_mn_idx_t_m02b + bl_mn_idx_t_m03 + 
                            bl_mn_idx_t_m16 + E4 + E3 + E8 + E2 + E5 + D7a + E7a,
                          family=binomial(link='logit'), data=micro_restr)
summary(model_glm_restr_D1)
exp(model_glm_restr_D1$coefficients)

model_glm_restr_D2 <- glm(depressed ~ bl_mn_idx_t + bl_mn_idx_t_m02a + bl_mn_idx_t_m02b + bl_mn_idx_t_m03 + 
                            bl_mn_idx_t_m16 + E4 + E3 + E8 + E2 + E5 + D7a + E7a,
                          family=binomial(link='logit'), data=micro_restr)
...
plot_models(all.models, m.labels = c("anxious (D1)", "depressed (D2)"), transform = NULL)
ggsave("Plots/models/model_glm_restr_D1_D2.png", width = 12, height = 9)
